...
import qbank.bus.front.MainFrameF;
import qbank.dao.SelectDAO;

public class AddSelect extends JPanel {
	...
	public void action(){
		add.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				boolean t=SelectDAO.addQuestion(questionT, answerAT, answerBT, answerCT, answerDT, answerT);
				if(t){
					question.setText("");
					answerA.setText("");
					answerB.setText("");

...
public class GetSelectD extends JPanel {
	public static int[]selectDSerial=null;
...
//					do{
						--index;
						int id=selectDSerial[index];
//						System.out.println(id);
						sel=Select_DDAO.getQuestion(id);
//					}while(sel.getFlag()==1);
		...
		getNext.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				if(index<selectDSerial.length-1){
//					do{
						++index;
						int id=selectDSerial[index];
//						System.out.println(id);

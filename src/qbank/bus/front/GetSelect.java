...
public class GetSelect extends JPanel {
	public static int[]selectSerial=null;
	...
	public GetSelect() {
		...
		this.setLayout(null);
//		answerA.setBounds(100, 270, 350, 120);
//		answerB.setBounds(510, 270, 350, 120);
//		answerC.setBounds(100, 400, 350, 120);
//		answerD.setBounds(510, 400, 350, 120);
...
//		a.setBounds(50, 320, 50, 20);
//		b.setBounds(460, 320, 50, 20);
//		c.setBounds(50, 430, 50, 20);
//		d.setBounds(460, 430, 50, 20);
...
//					do{
						index--;
						int id=selectSerial[index];
						sel=SelectDAO.getQuestion(id);
//					}while(sel.getFlag()==0);
		...
		getNext.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				if(index<selectSerial.length-1){
//					do{
						index++;
						int id=selectSerial[index];
						sel=SelectDAO.getQuestion(id);
//					}while(sel.getFlag()==1);//为了实现返回上一题功能，不能使用标记
					question.setText(sel.getQuestion());
					answerA.setText(sel.getAnswerA());
					answerB.setText(sel.getAnswerB());
					answerC.setText(sel.getAnswerC());
